...
const timelineEvents = [
  {
    ...
    location: "Table F-005",
    description: "Meet APEX Consulting Group near LSA Building and Thompson Street",
    active: false,
    icon: <Leaf className="h-5 w-5 font-bold" />,
  },
  {
    id: "meet-the-clubs",
  ...
  },
  {
    ...
    location: "Law Quad",
    description: "Meet an APEX member in a casual setting",
    active: false,
    icon: <MessageCircle className="h-5 w-5 font-bold" />,
  },
  {
    id: "career-panel",
    title: "Career Panel",
  ...
  // },
  {
    ...
    url: "https://docs.google.com/forms/d/e/1FAIpQLSd0iYpG7HcAO9T89Q56iGYsnMGr1kvRm_kCf1RgxMYMUUyXxQ/viewform?usp=header",
    linkText: "Apply here",
    active: false,
    icon: <Clock className="h-5 w-5 font-bold" />,
  },
  {
    id: "virtual-case-workshop",
    title: "Case Workshop",
  ...
  },
  {
    id: "interviews",
    title: "Interviews",
    date: "Friday, September 25, 2026 - Sunday September 27, 2026",
    time: "Various Times",
