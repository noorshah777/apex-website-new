...
export default function Home() {
  ...
  <Button
    asChild
    size="lg"
    className="bg-white text-red-600 hover:bg-white/90 font-bold text-lg"
  >
    <Link href="https://docs.google.com/forms/d/e/1FAIpQLSd0iYpG7HcAO9T89Q56iGYsnMGr1kvRm_kCf1RgxMYMUUyXxQ/closedform">
      Apply Now
    </Link>
  </Button>
  ...
  <Button
    ...
    className="bg-white text-red-600 hover:bg-white/90 font-bold text-lg"
  >
    <Link href="https://docs.google.com/forms/d/e/1FAIpQLSf8ZCD_F1aCKc2l_Jmbc_izBfFswKmhdJqv6rvOXsKel-8i9g/viewform">
      Interest Form
    </Link>
  </Button>
</div>
